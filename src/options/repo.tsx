...
type RepoProps = {
  ...
  onUpdateAutogenerated: (autogenerated: boolean) => void;
};
      ...
      <Card variant="outlined">
        ...
        <CardContent>
          <FormControl>
            ...
            />
            <FormHelperText>
              Depending on your settings, GitHub can recognise autogenerated
              files. When this option is enabled, those files will be auto
              approved.
            </FormHelperText>
          </FormControl>
        </CardContent>
