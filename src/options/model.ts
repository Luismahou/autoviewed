...
import { UnreachableCaseError } from '../base';
...
export type Action =
  ...
  | { kind: 'UPDATE_AUTOGENERATED'; repoId: number; autogenerated: boolean };
...
function addRepo(state: RepoList, name: string, autogenerated: boolean) {
...
function repoUpdateAutogenerated(
  state: RepoList,
  repoId: number,
  autogenerated: boolean,
) {
  const repo = getRepoOrThrow(state, repoId);
  castDraft(repo).autogenerated = autogenerated;
}
