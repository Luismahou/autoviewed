context('Repo List', () => {
  ...
  it('should have autogenerated flag enabled by default', () => {
    addRepository('foo/bar');
    cy.findByLabelText(/auto-generated/i).should('be.checked');
  });

  it('should update autogenerated flag', () => {
    addRepository('foo/bar');
    cy.findByLabelText(/auto-generated/i).click();
    cy.findByLabelText(/auto-generated/i).should('not.be.checked');
  });
